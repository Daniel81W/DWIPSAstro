...
class DWIPSSun extends IPSModule
{
    ...
    public function Create()
    {
        ...
        $p++;
        $this->MaintainVariable("season", $this->Translate("season"), "DWIPS." . $this->Translate("season"), 3, $p, false);
        $this->MaintainVariable("season", $this->Translate("season"), "DWIPS." . $this->Translate("season"), 3, $p, true);
        $p++;
