...
class DWIPSSun extends IPSModule
{
    ...
    public function Update()
    {
        ...
        $this->WriteAttributeFloat("topoSunRAsc", ASTROSUN::TopocentricSunRightAscension($this->ReadAttributeFloat("jce"), $this->ReadPropertyFloat("jd"), $this->ReadPropertyFloat("Latitude"), $this->ReadAttributeFloat("Longitude"), $this->ReadAttributeFloat("Elevetion")));
