...
class DWIPSSun extends IPSModule
{
    ...
    public function Update()
    {
        ...
        $this->WriteAttributeFloat("topoSunRAsc", ASTROSUN::TopocentricSunRightAscension($this->ReadAttributeFloat("jce"), $this->ReadAttributeFloat("jd"), $this->ReadPropertyFloat("Latitude"), $this->ReadPropertyFloat("Longitude"), $this->ReadPropertyFloat("Elevetion")));
